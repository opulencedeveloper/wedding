...
export default function Footer({ token = 'guest' }: FooterProps) {
  ...
  return (
    <footer className="px-5 py-[117px] md:py-[59px] overflow-hidden bg-c1c1c1e">
      {/* Schedule Card with Glassmorphism - matching image exactly */}
      <div className="max-w-[1197px] w-full mx-auto rounded-3xl pt-[75px] pb-[61px] md:px-[65px] text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h3 className="hidden md:block text-white font-greatvibes-400 text-[65px] mb-[26px] leading-none">
            Schedule
          </h3>

          {/* Horizontal Separator Line - thin, light gray, with padding */}
          <div className="w-full mx-auto h-px bg-gray-300/60 mb-5.5"></div>

          {/* Date and Location */}
          <p className="text-white font-nunito-400 text-xl leading-4">
            Saturday
          </p>
          <p className="text-white font-greatvibes-400 text-[40px] md:text-[54.84px] mb-8 md:mb-2 leading-tight">
            March 26. 2026
          </p>
          <p className="text-white font-greatvibes-400 text-[30px] text-[32.26px] mb-10 leading-5">
            Toronto, Canada
          </p>
