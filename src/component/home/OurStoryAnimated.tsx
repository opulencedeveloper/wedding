...
export default function OurStoryAnimated() {
  ...
  const contentOpacity = useTransform(scrollYProgress, [0, 0.3, 0.7, 1], [0, 1, 1, 0.9]);
  ...
  return (
    <section 
      ref={sectionRef}
      id="our-story" 
      className="px-4 md:px-5 pb-[100px] md:pb-[292.44px] love-story-rose-right-bg relative"
    >
      <motion.div
        ref={containerRef}
        style={{ y: contentY, opacity: contentOpacity }}
        className="max-w-308 b w-full mx-auto pt-[99px] md:pt-[212px]"
      >
        <motion.div
